    ...
    <main className="alinha pt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-8 mt-10 ease-in duration-300">
        <div className="rounded-lg shadow-lg transform transition hover:-translate-y-2 hover:shadow-2xl bg-custom-gradient p-10 alinha6 group ease-in duration-300">
          <h2 className="text-3xl lg:text-[2rem] font-semibold mb-4  text-[var(--corLetra2)] respoFont">
            Psicologia
          </h2>
          <Image
            src={pscicologa}
          ...
          />
          <p className="hidden text-gray-600 leading-relaxed mb-4 group-hover:block md:text-[1.3rem] lg:text-[1.2rem] respoFont">
          ...
          <Link
            href={"/contato"}
            className="bg-[var(--corLetra2)] text-[var(--corFundo)] hover:bg-[var(--corFundo)] hover:text-[var(--corLetra2)] p-1 rounded-sm border-2 border-[var(--corLetra2)] shadow-md lg:w-[18vw]  md:w-[40vw] w-[40vw] text-[1rem] md:text-[1.3rem] lg:text-[1.2rem] text-center font-semibold hover:scale-105 ease-in duration-300 respoFont "
          >
            Agende um Horário
          </Link>
        </div>
        ...
        <div className="rounded-lg p-10 shadow-lg transform transition hover:-translate-y-2 hover:shadow-2xl bg-custom-gradient alinha6 group ease-in duration-300">
          ...
          <Link
            href={"/contato"}
            className="bg-[var(--corLetra2)] text-[var(--corFundo)] hover:bg-[var(--corFundo)] hover:text-[var(--corLetra2)] p-1 rounded-sm border-2 border-[var(--corLetra2)] shadow-md lg:w-[18vw]  md:w-[26vw] w-[40vw] text-[1rem] md:text-[1.3rem] lg:text-[1.3rem] text-center font-semibold hover:scale-105 ease-in duration-300 respoFont"
          >
            Agende um Horário
          </Link>
        </div>
