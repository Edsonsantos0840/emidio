...
export const AdressFields : AdressProps[] =  [
  {
    ico: <FaMapMarkerAlt className="hover:scale-150 text-2xl text-corEspecial hover:text-principal transition-all ease-in duration-300" />,
    ...
    text: 'Dr. João Mascarenhas Neves, 67 - Jardim Bonfim'
  },
  {
    ico:  <FaPhoneAlt className="hover:scale-150 text-2xl text-corEspecial hover:text-principal transition-all ease-in duration-300" />,
  ...
  {
    ico: <FaEnvelope className="hover:scale-150 text-2xl text-corEspecial hover:text-principal transition-all ease-in duration-300" />, 
