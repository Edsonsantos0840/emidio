...
export const PiscologiaFields: PiscologiaProps[] = [
    {
    ...
    },
    {
      ...
      artigos: [
        ...
        "Gestão do tempo: Aprenda a gerenciar seu tempo de forma eficaz para equilibrar as diversas demandas da vida, incluindo trabalho, lazer e autocuidado.Autoconfiança: Trabalhar para construir uma autoimagem positiva e acreditar em suas capacidades para lidar com desafios e alcançar objetivos.",
