  ...
  return (
    <div className="min-h-screen w-full custom-gradient py-10 md:flex justify-center items-center ">
      ...
      <form onSubmit={captura} className="max-w-6xl mx-auto bg-white p-5 md:mt-16 rounded-xl shadow-lg space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <label className="flex flex-col">
            <div className="flex items-center space-x-2">
              <FaUserAlt className="text-[var(--corLetra2)]" /><span className="text-gray-700">*Nome:</span>
            </div>
            <input type="text" className="border-gray-300 border p-2 rounded-md" placeholder="Digite seu nome" value={nome} onChange={(e) => setNome(e.target.value)} />
          </label>

          {/* Email */}
          <label className="flex flex-col">
            <div className="flex items-center space-x-2">
              <FaEnvelope className="text-[var(--corLetra2)]" /><span className="text-gray-700">*E-mail:</span>
            </div>
            <input type="email" className="border-gray-300 border p-2 rounded-md" placeholder="Digite seu e-mail" value={email} onChange={(e) => setEmail(e.target.value)} />
          </label>

          {/* Telefone */}
          <label className="flex flex-col">
            <div className="flex items-center space-x-2">
              <FaPhoneAlt className="text-[var(--corLetra2)]" /><span className="text-gray-700">*Telefone:</span>
            </div>
            <input type="text" className="border-gray-300 border p-2 rounded-md" placeholder="Digite seu telefone" value={fone} onChange={(e) => setFone(e.target.value)} />
          </label>

          {/* Data */}
          <label className="flex flex-col">
            <div className="flex items-center space-x-2">
              <BsCalendarDate className="text-[var(--corLetra2)]" /><span className="text-gray-700">*Data:</span>
            </div>
            <input type="date" className="border-gray-300 border p-2 rounded-md" value={datas} onChange={(e) => setDatas(e.target.value)} />
          </label>
        ...
        <label className="flex flex-col">
          <div className="flex items-center space-x-2">
            <FaCommentAlt className="text-[var(--corLetra2)]" /><span className="text-gray-700">Deixe sua mensagem:</span>
          </div>
          <textarea className="border-gray-300 border h-24 p-2 rounded-md" placeholder="Escreva sua mensagem..." value={mensagem} onChange={(e) => setMensagem(e.target.value)}></textarea>
        </label>
