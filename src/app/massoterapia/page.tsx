    ...
    <main className="min-h-screen alinha pt-12">
      ...
      <section className="p-1 md:p-8 bg-fundoCard w-[90%] lg:w-[80%] rounded-md shadow-md group cursor-pointer transition-all ease-in-out duration-700">
        ...
        <p className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-[1500px] group-hover:opacity-100 transition-all duration-700 ease-in-out w-[95%] md:text-[1.3rem] lg:text-[1rem] m-auto py-6 respoFont">
          ...
          músculos e melhorar a circulação.
          <br />
          ...
          liberação miofascial, alongamento e pressão profunda.
          <br />
          ...
          equilibrar o fluxo de energia (conhecido como qi ou chi).
          <br />
          ...
          terapêutico com a pressão das pedras.
          <br />
          ...
          pode promover o equilíbrio e a cura.
          <br />
