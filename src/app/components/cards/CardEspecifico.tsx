  ...
  return (
    <div className="md:flex md:w-[50%] p-2 md:p-5 group hover:bg-[var(--fundoCard3)] md:hover:w-[150%] hover:shadow-2xl rounded-lg hover:border-2 border-[var(--corLetra2)] gap-5 ease-in duration-700">
      ...
      <article className=" pt-2 hidden group-hover:alinha6 gap-2 m-auto">
        ...
        <Link
          href={"/contato"}
          className="m-auto bg-[var(--corLetra2)] p-2 md:p-3 text-center text-[var(--corFundo)] rounded-md shadow-md hover:scale-105 hover:bg-[var(--terceira-cor)] w-[300px] md:w-full font-terceiraFont lg:font-fontPrincipal ease-in duration-300"
        >
          {props.agenda}
        </Link>
      </article>
