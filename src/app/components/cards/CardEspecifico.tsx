  ...
  return (
    <div className="lg:flex md:w-full p-2 md:p-5 group hover:bg-[var(--fundoCard3)] lg:hover:w-[150%] hover:shadow-2xl rounded-lg hover:border-2 border-[var(--corLetra2)] gap-5 ease-in duration-700">
      ...
      <article className=" pt-2 hidden group-hover:alinha6 gap-2 m-auto">
        ...
        <ul className="text-md md:text-[2rem]">
        ...
        <Link
          href={"/contato"}
          className="md:w-full m-auto bg-[var(--corLetra2)] p-2 md:p-3 text-center text-[var(--corFundo)] rounded-md shadow-md hover:scale-105 hover:bg-[var(--terceira-cor)] w-[300px] text-[1.2rem] md:text-[2rem] respoFont ease-in duration-300"
        >
          {props.agenda}
        </Link>
      </article>
