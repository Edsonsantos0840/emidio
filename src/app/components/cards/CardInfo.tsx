...
export default function CardInfo(props: CardInfoProps) {
  return (
    <div className="w-full group bg-[var(--fundoCard3)] shadow-2xl rounded-lg border-2 border-[var(--corLetra2)] gap-5 ease-in duration-700">
      <div className="flex w-full gap-10 group-hover:bg-[var(--fundoCard2)]" >
      <div >
        <Image src={props.imagem} alt="imagem" width={200} height={200} className="shadow-lg rounded-l-md group-hover:h-[100%] group-hover:w-[350px]"/>
      </div>
      <article className="gap-2 w-full group-hover:w-[90%] ease-in duration-700 ">
        ...
        <p className="group-hover:hidden">{props.texto}</p>
        <ul className="hidden group-hover:flex flex-col gap-2 m-auto py-4">
